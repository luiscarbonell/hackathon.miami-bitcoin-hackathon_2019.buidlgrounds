 ...
 /// get request
  ...
  render() {
    return (
      ...
      <img style={{ boxShadow: 'none', borderRadius: '0px'}} src={headImg} />
      </div>

      
        <div className="col-xs-3"></div>
        <div style={{ marginBottom: '25px', textAlign: 'left' }} className="col-xs-6">
...
pi@raspnode~$ sudo apt-get upgrade -y 
        ...
        <code>pi@raspnode~$ sudo apt-get install qt4-dev-tools <br /> libprotobuf-dev protobuf-compiler libqrencode-dev -y</code> <br /><br />
        <p>Make a directory to download required files:</p>
        <code>pi@raspnode~$ mkdir ~/bin
        <br />
        pi@raspnode~$ cd ~/bin</code> <br /><br />
